...
namespace BankingApp.Tests.Pages.Common {
    ...
    public class TitledPageTests
        : AbstractClassTests<PagedPage<IBlockChainsRepository, BlockChain, BlockChainView, BlockChainData>> {
        private class testClass :
            TitledPage<IBlockChainsRepository, BlockChain, BlockChainView, BlockChainData> {
        ...
        //public abstract class TitledPageTests<TRepository, TDomain, TView, TData> :
        //PagedPageTests<TRepository, TDomain, TView, TData>
        //where TRepository : class, ICrudMethods<TDomain>, ISorting, IFiltering, IPaging
        //where TView : PeriodView {

        //protected internal TitledPageTests(TRepository r, string title) : base(r) => PageTitle = title;
