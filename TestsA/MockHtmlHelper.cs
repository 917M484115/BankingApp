...
namespace BankingApp.Tests {
    internal class MockHtmlHelper<TPage> : IHtmlHelper<TPage> {
        ...
        public string DisplayNameFor<TResult>(Expression<Func<TPage, TResult>> e) => e?.ToString();
        ...
        public IHtmlContent Raw(object o) => new MockHtmlContent(o?.ToString());
        public IHtmlContent Raw(string s) => new MockHtmlContent(s?.ToString());
